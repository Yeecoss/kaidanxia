<template>
<!-- 商品组 -->
<view v-if="itemData && itemData.goodsList && itemData.goodsList.data && itemData.goodsList.data.length || (dataList && dataList.length)" class="diy-sharpGoods radius16" :style="'background: ' + itemStyle.background + ';'">
    ...
    <view class="sharp-top--left flex-box dis-flex flex-y-center">
      <block v-if="params.source=='hot'">
        <view class="sharp-title-img sharp-title164 dis-flex flex-y-center">
          <!-- <image lazy-load src="/static/images/hot-title.png" mode="widthFix"></image> -->
					<view class="tag f-32 col-2 m-r-30">
						<text class="iconfont2 icon-Hotsale m-r-10 color-hot"></text>热销爆款
					</view>
          <text class="col-6 f-24">总有一款你喜欢</text>
        </view>
      </block>
      <block v-else-if="params.source=='recommend'">
        <view class="sharp-title-img sharp-title164 dis-flex flex-y-center">
          <!-- <image lazy-load src="/static/images/recommend-title.png" mode="widthFix"></image> -->
					<view class="tag f-32 col-2 m-r-30">
						<text class="iconfont2 icon-recommend m-r-10 color-rec"></text>店主推荐
					</view>
          <text class="col-6 f-24">好货好价格</text>
        </view>
      </block>
      <block v-else>
        <view class="sharp-title-img1"><image lazy-load src="/static/images/sharp-title.png" mode="widthFix"></image></view>
      </block>
