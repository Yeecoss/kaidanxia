...
<view class="mobileLogin">
  <!-- 自定义标题栏 -->
  <navigationBar title="绑定手机号"></navigationBar>
  <view class="container">
    <form @submit="formSubmit">
      <view class="inputBox  dis-flex">
        ...
        <view>
          <input placeholder-class="uni-input" class="inputClass" type="number" v-model="mobileNum" :maxlength="11" placeholder="输入您的手机号" />
        </view>
      </view>
      <view class="inputBox">
